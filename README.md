...
- Solution URL: [Solution URL](https://github.com/nishanth1596/react-quiz)
- Live Site URL: [Live site URL](https://nishanth1596-react-quiz.netlify.app/)
...
1. Clone this repository:
   ...
   ```bash
   git clone https://github.com/nishanth1596/react-quiz.git
   ```
